...
export default function AccountManagement() {
    return <>
        <div className='AccountManagement w-full h-full p-8'>
            ...
            <div className="personal-info w-2/3 p-5 rounded-md bg-white shadow-lg h-fit">
                ...
                <div className="name mt-7">
                    ...
                    <input type="text" className='w-2/3 h-9 border-2 rounded-md' />
            ...
            <div className="login-info w-2/3 p-5 mt-7 rounded-md bg-white shadow-lg ">
                <p className='text-lg pb-4 font-medium text-gray-700'>Personale Information</p>
                ...
                <div className="name mt-7 ">
                    ...
                    <input type="text" className='w-2/3 h-9 border-2 rounded-md' />
                    <button className=' bg-slate-100 hover:bg-sky-600 hover:text-white ms-2 border h-9 px-5 rounded-md'> Edit</button>
                ...
                <div className="name mt-7">
                    ...
                    <input type="text" className='w-2/3 h-9 border-2 rounded-md' />
                    <button className=' bg-slate-100 ms-2 hover:bg-sky-600 hover:text-white border h-9 px-5 rounded-md'> Change My Passwrod</button>
