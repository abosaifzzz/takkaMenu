            ...
            <div className="bg-white shadow-lg rounded-2xl flex max-w-3xl p-5 items-center">
                <div className="md:w-1/2 px-8">
                    ...
                    <form action="" className="flex flex-col gap-4">
                        ...
                        <button className="bg-[#002D74] text-white py-2 rounded-xl hover:scale-105 duration-300 hover:bg-[#206ab1] font-medium" type="submit"><Link to={"/dashboard"}>Login</Link></button>
                    </form>
